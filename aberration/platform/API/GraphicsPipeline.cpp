...
namespace AB::API
{
	...
	void InitPipeline(Pipeline* pipeline)
	{
		...
		SetZeroScalar(Pipeline, pipeline);
	...
	{
		PipelineState* c = &pipeline->currentState;
		PipelineState* p = &pipeline->lastCommitedState;
	...
	inline void SetBlendFactor(Pipeline* pip,
	...
	inline void PipelineRequireState(PipelineState* pipeline, PipelineConfig state)
	{
