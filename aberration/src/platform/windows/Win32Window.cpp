...
namespace AB {
	...
	namespace Window {
		...
		//	state.currentState = window->keys[(uint32)key].currentState;
		//	state.prevState = window->keys[(uint32)key].prevState;
		//	return state;
		//}
		...
		//	state.currentState = window->mouseButtonsCurrentState[(uint32)button];
		//	state.prevState = window->mouseButtonsCurrentState[(uint32)button];
		//	return state;
		//}
		...
		//	auto window = PermStorage()->window;
		//
		//	window->focusCallback = func;
		//	window->focusCallbackUserData = userData;
		//}
		...
		//	*yPos = window->height - window->mousePositionY;
		//}
